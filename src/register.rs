...
impl ClassRegister {
    ...
    pub fn create_repo( &self){
        git_wrapper::create_repo(&self.username,
                                 &self.password,
                                 &self.repo_name,
                                 "/tmp/");
    }
    ...
    pub fn clone_repo_to_private( &self){
        git_wrapper::clone_class_repo_to_private(&self.username,
                                                 &self.password,
                                                 &self.repo_name,
                                                 "/tmp/",
    ...
    pub fn clone_repo_to_dir( &self ){
        git_wrapper::clone_repo_to_dir(&self.username,
                                       &self.password,
                                       &self.repo_name,
                                       "/tmp/");
    }
    ...
    pub fn add_deploy_key( &self, key: &str){
        git_wrapper::add_deploy_key(&self.username,
                                    &self.password,
                                    &self.repo_name,
                                    "/tmp/",
                                    key);
